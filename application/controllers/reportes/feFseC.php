...
class feFseC extends CI_Controller {
    ...
    public function feFseC() {
        ...
        //$numeroControl='DTE-14-CMPV0202-000000000000306';
        //$codigoGeneracion='420B64C0-9873-4296-A300-47461D1A301F';
        ...
        $pdf->Cell( 97,4, utf8_decode( strtoupper( "DOCUMENTO TRIBUTARIO ELECTRÓNICO - FACTURA SUJETO EXCLUIDO" ) ), 1, 0, 'C' );
