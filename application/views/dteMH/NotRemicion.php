                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <form class="form-horizontal" id="receptor">
                                    ...
                                    <div class="col-md-6 col-sm-6  form-group ">
                                        <input type="text" class="form-control " id="contenedor" placeholder="contenedor" >
                                    </div>
                                    <div class="col-md-6 col-sm-6  form-group ">
                                    ...
                                    <div class="col-md-2 col-sm-2  form-group ">
                                        <select class="form-control" id="tipoDoc">
                                            <option value="E">Comprobante Electronico</option>
                                            <option value="F">Comprobante Fisico</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2 col-sm-2  form-group ">
                                    ...
                                    <div class="col-md-4 col-sm-4  form-group ">
                                        <input type="text" class="form-control " id="dtevincontrol" placeholder="DTE vinculado" >
                                    </div>
                                    <div class="col-md-4 col-sm-4  form-group ">
                                        <input type="text" class="form-control " id="dtevincodgen" placeholder="Codigo Generacion / serie" >
                                    </div>
